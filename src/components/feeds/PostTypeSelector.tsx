  ...
  return (
    <Card className="border-0 shadow-sm">
      ...
      <CardContent>
        <div
          className={cn(
            isMobile ? "flex flex-col gap-3" : "grid grid-cols-1 gap-3"
          )}
        >
          {postTypes.map((type) => {
            ...
            return (
              <button
                ...
                type="button"
                className={cn(
                  "p-4 rounded-lg border-2 text-left transition-all flex-1 focus:outline-none focus:ring-2 focus:ring-primary",
                  postType === type.id 
              ...
              >
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className={cn("font-medium", postType === type.id ? "text-primary" : "text-gray-800")}>
                      {type.label}
                    </h3>
